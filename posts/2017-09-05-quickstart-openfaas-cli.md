---
title: "Morning coffee with the OpenFaaS CLI"
slug: "quickstart-openfaas-cli"
date: "2017-09-05T07:20:00Z"
author: "Alex Ellis"
meta_title: "Morning coffee with the OpenFaaS CLI"
meta_description: "I'll show you how to create, build, deploy and invoke a brand new function with one of the supported language templates. Follow along with your morning brew"
tags:
  - "openfaas"
  - "swarm"
  - "kubernetes"
...
This is a short blog post that you can follow along with while sipping your morning brew. I'll show you how to create, build, deploy and invoke a brand new function with one of the supported language templates. We'll use the CLI for every part of the workflow.
...
* [Setup OpenFaaS with Docker Swarm](https://github.com/alexellis/faas/blob/master/guide/deployment_swarm.md)
* [Setup OpenFaaS with Kubernetes](https://github.com/alexellis/faas/blob/master/guide/deployment_k8s.md)
...
If you have questions, comments or suggestions please reach out on [Twitter](https://twitter.com/alexellisuk) or join us on Slack by emailing: [alex@openfaas.com](alex@openfaas.com).

**Mentions**

Thanks to the community and OpenFaaS users for suggesting enhancements and for giving feedback on the user-experience.

A special mention goes out to [John McCabe](https://twitter.com/mccabejohn) from [Puppet](https://puppet.com) who spent several days upgrading the CLI to use [Cobra packages](https://github.com/alexellis/faas-cli/pull/50) instead of the built-in [Golang arguments parser](https://gobyexample.com/command-line-flags).